...
const about =
  'I am a full-stack developer who enjoys turning ideas into simple, useful websites and apps, using AI tools to build faster while reviewing every detail by hand. Beyond software, I also have experience in e-commerce support and administrative work. I am flexible and quick to adapt, and I am comfortable taking on whatever a team or client needs.';

const experience = [
  { title: 'E-commerce Support', description: 'Product listings, store page updates and content management for online shops.' },

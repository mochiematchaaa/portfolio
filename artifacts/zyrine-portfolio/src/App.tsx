...
const about =
  'I am a full-stack developer who enjoys turning ideas into simple, useful websites and apps, using AI tools to build faster while reviewing every detail by hand. Beyond software, I also have administrative experience, including marketing data entry with Excel and HubSpot. I am flexible and quick to adapt, and I am comfortable taking on whatever a team or client needs.';

const experience: { title: string; description: string }[] = [
  { title: 'Marketing Data Entry Intern — Redstar Asia Solutions Inc.', description: 'Administrative internship: marketing data entry and records management using Excel and HubSpot.' },
  { title: 'IT Intern — Modernext IT Solution Corp', description: 'Feb 2026 – Apr 2026 · Computer hardware setup and support, plus graphic editing in Canva.' },
  { title: 'Administrative Support', description: 'Document preparation, spreadsheets, data entry and records management using Microsoft Office.' },
];
        ...
        <div className="container narrow">
          ...
          <div className="facts reveal" style={d(3)}>
            <div>
              ...
              {experience.map((e) => (
                <p className="fact-item" key={e.title}><strong>{e.title}</strong><small>{e.description}</small></p>
              ))}
            </div>
